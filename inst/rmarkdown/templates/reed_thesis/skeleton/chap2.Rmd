...
You saw much of this executed in Chapter \ref{chap:rmd_basics}.  If we'd like to reference the plot we made there, we enter the following inline **R** code:  `r figr('march3-plot', type = "figure", link = TRUE)`.
