...
Now that we've gone over some of the basics of getting used to using R Markdown in [](#rmd-basics), we will explore how to reference different spots in your document by using labels.  Anytime you enter a hashtag (or multiple hashtags) to begin a section or subsection, Markdown will automatically create a label for that section.  For example, in [](#rmd-basics), we had a subsection called "Unordered versus ordered."  Markdown created a label automatically (replacing spaces with hyphens).  We can create a link to this subsection (which will automatically correspond to the appropriate number of the subsection): [](#unordered-versus-ordered).
