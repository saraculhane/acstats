...
The following figure features the more popular changes thesis students want to their figures. We can add math to the caption that displays below the picture, have that caption be smaller by using the `tinycap` parameter, and also specify that a different caption be what appears in the Table of Figures for this figure.
...
label("subdivision.pdf", 
      ...
      tinycap = "Subdivision of arc segments. You can see that $ p_3 = p_6^\prime$",
      label = "subd3")
```
