...
To create a sublist, just indent the values a bit.  (Here's one case where indentation is key!)
...
pkg <- c("dplyr", "ggplot2", "knitr", "kfigr")
...
library(ggplot2)
library(knitr)
library(kfigr)  # Used for labelling figures, chunks, etc.
```
...
<!--
You'll see why these chunks are nice when we look at cross referencing in Chapter 2.
-->
