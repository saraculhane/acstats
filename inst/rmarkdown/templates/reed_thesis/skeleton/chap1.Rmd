...
When you click the **Knit** button a document will be generated that includes both content as well as the output of any embedded **R** code chunks within the document. You can embed an R code chunk like this (using the built-in `cars` dataset in **R**):
...
Mathematics can be added by surrounding the mathematical text with dollar signs.  More examples of this are in [](#math-sci).  

<!--
You'll see more details on this cross-referencing in Chapter 2.
-->
