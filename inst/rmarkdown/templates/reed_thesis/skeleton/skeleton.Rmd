...
<!--
This is for including Chapter 1.  Notice that it's also good practice to name your chunk.  This will help you debug potential issues as you knit.  The chunk above is called intro and the one below is called chapter1.

The \label{chap:rmd_basics} text after the chapter declaration will allow us to link throughout the document back to the beginning of Chapter 1.  Look for this at the beginning of Chapter 2.
-->

<!--
\chapter{R Markdown Basics}
\label{chap:rmd_basics} 
-->
