...
preface: >
  This is an example of a thesis setup to use the Amherst thesis document class.
bibliography: bib/thesis.bib
# Download your specific bibliography database file and refer to it in the line above.
csl: csl/apa.csl
# Download your specific csl file and refer to it in the line above.
output: 
<<<<<<< HEAD:inst/rmarkdown/templates/amherst_thesis/skeleton/skeleton.Rmd
  rticles::amherst_thesis:
=======
  reedtemplates::reed_thesis:
>>>>>>> ismayc/master:inst/rmarkdown/templates/reed_thesis/skeleton/skeleton.Rmd
    toc: true
lot: true
lof: true
#header-includes:
